...
- Bump JavaScript SDK from v10.18.0 to v10.57.0 ([#3](https://github.com/Aetonix/sentry-react-native/pull/3))
  - [changelog](https://github.com/getsentry/sentry-javascript/blob/develop/CHANGELOG.md#10570)
  - [diff](https://github.com/getsentry/sentry-javascript/compare/10.18.0...10.57.0)
